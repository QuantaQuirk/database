...
trait BuildsQueries
{
     ...
     * @return \QuantaQuirk\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder  $builder
     ...
     *
     * @param  \QuantaQuirk\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \QuantaQuirk\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \QuantaQuirk\Pagination\Paginator
     */
     ...
     * @param  \QuantaQuirk\Support\Collection  $items
     * @param  int  $perPage
     * @param  \QuantaQuirk\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \QuantaQuirk\Pagination\CursorPaginator
     */
