...
class ShowModelCommand extends DatabaseInspectionCommand
{
    ...
    public function handle()
    {
        ...
        try {
            $model = $this->quantaquirk->make($class);
    ...
    {
        $listeners = $this->getQuantaQuirk()->make('events')->getRawListeners();
     ...
     * @param  string  $table
     * @param  string  $policy
     * @param  \QuantaQuirk\Support\Collection  $attributes
     * @param  \QuantaQuirk\Support\Collection  $relations
     * @param  \QuantaQuirk\Support\Collection  $observers
     * @return void
     */
     ...
     * @return string
     *
     * @see \QuantaQuirk\Console\GeneratorCommand
     */
    protected function qualifyModel(string $model)
    {
        ...
        $rootNamespace = $this->quantaquirk->getNamespace();
