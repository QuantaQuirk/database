...
use Closure;
use Exception;
use QuantaQuirk\Contracts\Database\Eloquent\Builder as BuilderContract;
...
use QuantaQuirk\Database\Eloquent\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \QuantaQuirk\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \QuantaQuirk\Database\Query\Builder
     */
    protected $query;
     ...
     * @return \QuantaQuirk\Database\Eloquent\Model|static
     */
     ...
     * @param  \QuantaQuirk\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \QuantaQuirk\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\QuantaQuirk\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\QuantaQuirk\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \QuantaQuirk\Database\Eloquent\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection|static|static[]
     *
     ...
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \QuantaQuirk\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \QuantaQuirk\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \QuantaQuirk\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \QuantaQuirk\Database\Eloquent\Model|$this
     */
     ...
     *
     * @param  array|\QuantaQuirk\Contracts\Database\Query\Expression  $columns
     * @return array
     */
