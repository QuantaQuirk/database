...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @return $this
     *
     * @throws \QuantaQuirk\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \QuantaQuirk\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \QuantaQuirk\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     * @return \QuantaQuirk\Database\Eloquent\Relations\Pivot
     */
     ...
     *
     * @return \QuantaQuirk\Database\ConnectionResolverInterface|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \QuantaQuirk\Database\Eloquent\Relations\Relation
     */
