...
use QuantaQuirk\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
...
class HasManyThrough extends Relation
{
     ...
     *
     * @param  \QuantaQuirk\Database\Eloquent\Builder|null  $query
     * @return void
     */
    ...
    protected function buildDictionary(Collection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[$result->quantaquirk_through_key][] = $result;
        }
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection
     *
     * @throws \QuantaQuirk\Database\Eloquent\ModelNotFoundException<\QuantaQuirk\Database\Eloquent\Model>
     */
     ...
     * @param  \Closure|array  $columns
     * @param  \Closure|null  $callback
     * @return \QuantaQuirk\Database\Eloquent\Model|\QuantaQuirk\Database\Eloquent\Collection|mixed
     */
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        return array_merge($columns, [$this->getQualifiedFirstKeyName().' as quantaquirk_through_key']);
    }
