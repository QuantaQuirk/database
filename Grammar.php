...
abstract class Grammar
{
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $value
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string|int|float  $expression
     ...
     *
     * @param  \QuantaQuirk\Database\Connection  $prefix
     * @return $this
     */
