...
namespace QuantaQuirk\Database\Query;

use BackedEnum;
use Carbon\CarbonPeriod;
use Closure;
use DateTimeInterface;
use QuantaQuirk\Contracts\Database\Query\Builder as BuilderContract;
use QuantaQuirk\Contracts\Database\Query\ConditionExpression;
use QuantaQuirk\Contracts\Database\Query\Expression as ExpressionContract;
use QuantaQuirk\Contracts\Support\Arrayable;
use QuantaQuirk\Database\Concerns\BuildsQueries;
use QuantaQuirk\Database\Concerns\ExplainsQueries;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \QuantaQuirk\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \QuantaQuirk\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \QuantaQuirk\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \QuantaQuirk\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \QuantaQuirk\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|string  $first
     * @param  string|null  $operator
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \QuantaQuirk\Database\Query\JoinClause
     */
     ...
     *
     * @param  \Closure|string|array|\QuantaQuirk\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $column
     * @param  mixed  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  string  $column
     * @param  \QuantaQuirk\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\QuantaQuirk\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\QuantaQuirk\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  array|\QuantaQuirk\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|\Closure|string  $column
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder|\QuantaQuirk\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\QuantaQuirk\Database\Query\Builder|\QuantaQuirk\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \QuantaQuirk\Database\RecordsNotFoundException
     * @throws \QuantaQuirk\Database\MultipleRecordsFoundException
     */
     ...
     * @return \QuantaQuirk\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \QuantaQuirk\Contracts\Pagination\Paginator
     */
     ...
     * @param  \QuantaQuirk\Pagination\Cursor|string|null  $cursor
     * @return \QuantaQuirk\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @return \QuantaQuirk\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \QuantaQuirk\Database\Query\Grammars\Grammar
     */
