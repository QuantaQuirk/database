...
class Blueprint
{
     ...
     *
     * @var \QuantaQuirk\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \QuantaQuirk\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \QuantaQuirk\Support\Fluent
     */
     ...
     * @return \QuantaQuirk\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \QuantaQuirk\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \QuantaQuirk\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \QuantaQuirk\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Schema\ColumnDefinition  $definition
     * @return \QuantaQuirk\Database\Schema\ColumnDefinition
     */
